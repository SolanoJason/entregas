...
public enum Control {
    ...
    /**
     * Retorna TRUE si la consulta retorna al menos una fila Retorna FALSE si la
     * consulta falla o no retorna nada
     */
     ...
     * Retorna un INTEGER con valor del número de filas afectadas por la
     * consulta
     */
